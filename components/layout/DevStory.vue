...
const historyItems = ref<TimelineItem[]>([
  ...
  {
    date: '11 июля 2025',
    title: 'Смена пароля, мини-профиль',
    description:
      'Добавлена возможность смены пароля в профиле с проверкой старого пароля и валидацией новых данных. Реализован мини-профиль, который появляется при наведении курсора на имя пользователя. Отображает краткую информацию: аватар, имя, описание и т. д.',
